# Linearize
Construct a linear, no-fork, best version of the ExodusX blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install exodusx_hash

https://github.com/exodusx/exodusx_hash
...
JSON-RPC server. Running `exodusxd` or `exodusx-qt -server` will be sufficient.
...
* `input`: exodusxd blocks/ directory containing blkNNNNN.dat
