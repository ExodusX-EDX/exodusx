...
Below are some notes on how to build ExodusX Core for Windows.
...
way. This will install to `c:\workspace\exodusx`, for example:

    make install DESTDIR=/mnt/c/workspace/exodusx
